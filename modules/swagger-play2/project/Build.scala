...
object ApplicationBuild extends Build {
  ...
  val appVersion = "1.3.8-NYC-SNAPSHOT"
  ...
  val appDependencies: Seq[sbt.ModuleID] = Seq(
    ...
    "com.wordnik" % "swagger-jaxrs_2.10" % "1.3.8-NYC-SNAPSHOT",
    "javax.ws.rs" % "jsr311-api" % "1.1.1",
    "org.mockito" % "mockito-core" % "1.9.5" % "test")

  val main = Project(appName, file(".")).settings(
    version := appVersion,
    scalaVersion := System.getProperty("scala.version", "2.11.2"),
    ...
    resolvers := Seq(
      ...
      "Typesafe Repository" at "http://repo.typesafe.com/typesafe/releases/")).enablePlugins(PlayScala)
}
